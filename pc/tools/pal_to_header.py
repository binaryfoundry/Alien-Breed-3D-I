#!/usr/bin/env python3
"""
Convert .pal files in pc/data/pal to C tables in pc/src/sprite_palettes_data.h.
Run from repo root or from pc/:  python tools/pal_to_header.py
...
def main() -> int:
    ...
    pal_dir = repo / "pc" / "data" / "pal"
    out_header = repo / "pc" / "src" / "sprite_palettes_data.h"
    ...
    lines = [
        "/* Generated by pc/tools/pal_to_header.py from pc/data/pal/*.pal. Do not edit. */",
